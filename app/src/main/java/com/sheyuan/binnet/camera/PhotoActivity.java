package com.sheyuan.binnet.camera;
...
import com.sheyuan.baselibrary.picture.PictureSelector;
import com.sheyuan.baselibrary.picture.compress.Luban;
...
import com.sheyuan.binnet.R;
import com.sheyuan.binnet.camera.adapter.GridImageAdapter;
            ...
            public void onItemClick(int position, View v) {
                if (selectList.size() > 0) {
                    ...
                    switch (mediaType) {
                        case 1:
                            // 预览图片 可自定长按保存路径
                            //PictureSelector.create(PhotoActivity.this).externalPicturePreview(position, "/custom_file", selectList);
