package com.sheyuan.baselibrary.picture;
...
import com.sheyuan.baselibrary.picture.adapter.PictureAlbumDirectoryAdapter;
import com.sheyuan.baselibrary.picture.adapter.PictureImageGridAdapter;
import com.sheyuan.baselibrary.picture.config.PictureConfig;
import com.sheyuan.baselibrary.picture.config.PictureMimeType;
import com.sheyuan.baselibrary.picture.decoration.GridSpacingItemDecoration;
import com.sheyuan.baselibrary.picture.dialog.CustomDialog;
import com.sheyuan.baselibrary.picture.entity.EventEntity;
import com.sheyuan.baselibrary.picture.entity.LocalMedia;
import com.sheyuan.baselibrary.picture.entity.LocalMediaFolder;
import com.sheyuan.baselibrary.picture.model.LocalMediaLoader;
import com.sheyuan.baselibrary.picture.observable.ImagesObservable;
import com.sheyuan.baselibrary.picture.tools.AttrsUtils;
import com.sheyuan.baselibrary.picture.tools.DateUtils;
import com.sheyuan.baselibrary.picture.tools.DebugUtil;
import com.sheyuan.baselibrary.picture.tools.DoubleUtils;
import com.sheyuan.baselibrary.picture.tools.LightStatusBarUtils;
import com.sheyuan.baselibrary.picture.tools.PictureFileUtils;
import com.sheyuan.baselibrary.picture.tools.ScreenUtils;
import com.sheyuan.baselibrary.picture.tools.StringUtils;
import com.sheyuan.baselibrary.picture.ucrop.UCrop;
import com.sheyuan.baselibrary.picture.ucrop.UCropMulti;
import com.sheyuan.baselibrary.picture.ucrop.model.CutInfo;
import com.sheyuan.baselibrary.picture.widget.FolderPopWindow;
import com.sheyuan.baselibrary.picture.widget.PhotoPopupWindow;
...
public class PictureSelectorActivity extends PictureBaseActivity implements View.OnClickListener,
    ...
    private void initView(Bundle savedInstanceState) {
        ...
        mediaLoader = new LocalMediaLoader(this, mimeType, isGif, videoMaxSecond, videoMinSecond);
        rxPermissions.request(Manifest.permission.READ_EXTERNAL_STORAGE)
                .subscribe(new Observer<Boolean>() {
                    @Override
                    public void onSubscribe(Disposable d) {
