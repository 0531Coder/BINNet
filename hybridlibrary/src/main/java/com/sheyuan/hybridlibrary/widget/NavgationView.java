package com.sheyuan.hybridlibrary.widget;
...
public class NavgationView extends FrameLayout {
    ...
    private void init() {
        ...
        mLeftIcon = (ImageView) findViewById(R.id.hybrid_icon_left);
        mRightIcon = (ImageView) findViewById(R.id.hybrid_icon_right);
    }
    ...
    private void appendInner(Direct direct, String label, Object icon, OnClickListener clickListener) {
        ...
        ImageView iconView = (ImageView) viewGroup.findViewById(R.id.hybrid_icon);
